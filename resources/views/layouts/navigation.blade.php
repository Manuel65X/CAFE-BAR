<nav x-data="{ open: false }" class=" dark:bg-black pb-4 pt-4 ">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('bookings.reserva')" :active="request()->routeIs('bookings.reserva')">
                        {{ __('Bookings') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('bookings.reserva')" :active="request()->routeIs('bookings.reserva')">
                {{ __('Bookings') }}
            </x-responsive-nav-link>
        </div>
...
<div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
    ...
    <div class="mt-3 space-y-1">
        @auth
            <!-- Display links only when the user is authenticated -->
